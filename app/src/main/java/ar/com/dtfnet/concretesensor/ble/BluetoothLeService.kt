...
class BluetoothLeService : Service() {
    ...
    private val mGattCallback = object : BluetoothGattCallback() {
        override fun onConnectionStateChange(gatt: BluetoothGatt, status: Int, newState: Int) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                Log.i(TAG, "Attempting to start service discovery:$discover")
    ...
    fun setCharacteristicNotification(characteristic: BluetoothGattCharacteristic,
        ...
        if (SampleGattAttributes.QCA402xCharacteristicUUID == characteristic.uuid) {
        ...
        if (SampleGattAttributes.QCA402xSendCharacteristicUUID == characteristic.uuid) {
            val descriptor = characteristic.getDescriptor(
                SampleGattAttributes.CLIENT_CHARACTERISTIC_CONFIG
            )
            descriptor.value = BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE
